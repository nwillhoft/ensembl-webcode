...
sub render_species_list {
  ...
  my $html = sprintf qq{<div class="static_favourite_species"><h3 class="box-header">%s genomes</h3><div class="species_list_container species-list">$fav_html</div>%s</div>}, 
